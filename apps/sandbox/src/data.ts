...
function logToActivityEvent(log: {
    ...
    const action = log.message.split(' ').slice(0, 3).join(' ') || 'checkout_event'
...
const rawLogs = [
    ...
    },
    {
        ...
        service: 'shipping',
        message:
            'Shipment picked up for order ord_efg234. Package collected.',
        metadata: {
            request_id: 'req_bcd901',
            user_id: 'user_grace_890',
            shipment_id: 'ship_efg234',
    ...
    },
    {
        ...
        service: 'shipping',
        message:
            'Shipment delivered for order ord_efg234. Package delivered.',
        metadata: {
            request_id: 'req_bcd901',
            user_id: 'user_grace_890',
            shipment_id: 'ship_efg234',
    ...
    },
    {
        ...
        service: 'shipping',
        message:
            'Shipment picked up for order ord_klm567. Package collected.',
        metadata: {
            request_id: 'req_hij234',
            user_id: 'user_henry_123',
            shipment_id: 'ship_klm567',
    ...
    },
    {
        ...
        service: 'shipping',
        message:
            'Shipment picked up for order ord_qrs890. Fast pickup completed.',
        metadata: {
            request_id: 'req_nop567',
            user_id: 'user_isabel_456',
            shipment_id: 'ship_qrs890',
    ...
    },
    {
        ...
        service: 'shipping',
        message:
            'Shipment picked up for order ord_wxy123. Package collected.',
        metadata: {
            request_id: 'req_tuv890',
            user_id: 'user_jack_789',
            shipment_id: 'ship_wxy123',
