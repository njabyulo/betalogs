...
> {
            ...
            if (
              ...
              if (total > shown) {
                console.log({
                  ...
                  compression:
                    "Smart selection applied (critical + temporal distribution)",
                });
              } else {
                console.log({
                  output: part.output,
  ...
  async generateText(
      ...
      try {
        ...
        try {
          ...
          if (validationError instanceof z.ZodError) {
            ...
            const missingStory =
              errorDetails.includes("story") &&
              (errorDetails.includes("undefined") ||
    ...
    return {
      text: result.text,
      output: parsedOutput as TSchema extends z.ZodTypeAny
        ? z.infer<TSchema>
        : never,
    };
  }
