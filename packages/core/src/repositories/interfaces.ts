...
export type { AgentAdapter } from "../adapters";
...
export interface ICreateIndexingRepositoryOptions extends ICreateSearchAdapterOptions {}

export interface IChatRepository<TSchema extends z.ZodTypeAny> {
  chat(prompt: string): Promise<z.infer<TSchema>>;
}

export interface IChatRepositoryOptions<
  D,
  T extends ToolSet,
