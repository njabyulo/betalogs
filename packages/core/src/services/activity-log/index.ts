import type { ISearchAdapter, ISearchAdapterExactSearchArgs, ISearchAdapterExactSearchResult } from '../../adapters/interfaces'
import { createSearchAdapter } from '../../adapters/open-search'

export interface IActivityLogService {
    searchExact(args: ISearchAdapterExactSearchArgs): Promise<ISearchAdapterExactSearchResult[]>
}
...
class ActivityLogService implements IActivityLogService {
    ...
    async searchExact(args: ISearchAdapterExactSearchArgs): Promise<ISearchAdapterExactSearchResult[]> {
        return await this.searchAdapter.exactSearch(args)
    }
}

export function createActivityLogService(options: ICreateActivityLogServiceOptions): IActivityLogService {
