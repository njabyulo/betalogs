...
export interface ICreateIndexingServiceOptions extends ICreateIndexingRepositoryOptions {}
...
export interface ICreateMetadataRegistryServiceOptions extends ICreateMetadataRegistryRepositoryOptions {}
